 ...
 */
export declare class AngularFirestoreCollection<T extends DocumentData = DocumentData> {
     ...
     */
    doc<T2 extends DocumentData = T>(path?: string): AngularFirestoreDocument<T2>;
}
