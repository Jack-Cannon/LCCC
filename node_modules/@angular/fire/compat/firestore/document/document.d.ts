 ...
 */
export declare class AngularFirestoreDocument<T extends DocumentData = DocumentData> {
     ...
     * function.
     */
    collection<R extends DocumentData = DocumentData>(path: string, queryFn?: QueryFn): AngularFirestoreCollection<R>;
    /**
