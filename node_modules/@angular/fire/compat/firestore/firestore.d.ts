...
export declare class AngularFirestore {
     ...
     * set.
     */
    collection<T extends DocumentData>(path: string, queryFn?: QueryFn): AngularFirestoreCollection<T>;
    collection<T extends DocumentData>(ref: CollectionReference, queryFn?: QueryFn): AngularFirestoreCollection<T>;
    /**
